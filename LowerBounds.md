...
Ако задачата MinDist3D се решава за o(nlgn), то и задачата MinDist ще се решава за o(nlgn) + O(n) = max{o(nlgn),O(n)} = o(nlgn) време. Това е в противоречие с доказаната сложност по време на MinDist от Ω(nlgn) => не е възможно MinDist3D да се решава за o(nlgn) и това е теоретичната долна граница - също Ω(nlgn).
